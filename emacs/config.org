...
#+END_SRC
** Org SCRUM
Load ~ry-org-scrum~ if not installed
#+BEGIN_SRC emacs-lisp
  (unless (package-installed-p 'ry-org-scrum)
    (package-install-file "~/Builds/ry-org-scrum/ry-org-scrum.el"))
#+END_SRC
...
#+END_SRC
** Shrug
A tiny function that makes pasting an ASCII shrug into my notes much
easier...
...
** Disapproval
A tiny function that makes it easy to paste in a disapproval face.
