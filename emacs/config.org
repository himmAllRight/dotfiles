...
(use-package fill-column-indicator
    :ensure t) 
#+END_SRC 
>>>>>>> 74706c3762657efacfbe263fe3d138cdced89a92
** Parens
...
(when (string-equal (upcase system-name) "LAFAYETTE")
  (load "~/dotfiles/emacs/.emacs-work.el"))
=======
  (when ( or (string-equal (upcase system-name) "LAFAYETTE")
             (string-equal (upcase system-name) "LAFAYETTE-LAPTO"))
    (load "~/.emacs-work.el"))
>>>>>>> 74706c3762657efacfbe263fe3d138cdced89a92
#+END_SRC
** Linux
